...
import ru.baikalos.extras.preference.SecureSettingMasterSwitchPreference;
import ru.baikalos.extras.preference.SecureSettingSwitchBarController;
import ru.baikalos.extras.preference.SystemSettingMasterSwitchPreference;
...
public class SettingsActivity extends BaseActivity {
    ...
    private static final String EXTRA_SWITCH_SYSTEM_SETTINGS_KEY =
            "ru.baikalos.extras.extra.preference_switch_system_settings_key";
    ...
    private static final String EXTRA_SWITCH_SYSTEM_SETTINGS_DEFAULT_VALUE =
            "ru.baikalos.extras.extra.preference_switch_system_settings_default_value";
    ...
    private static final String EXTRA_SWITCH_SECURE_SETTINGS_KEY =
            "ru.baikalos.extras.extra.preference_switch_secure_settings_key";
    // Default value for switch bar controlling the system setting
    private static final String EXTRA_SWITCH_SECURE_SETTINGS_DEFAULT_VALUE =
            "ru.baikalos.extras.extra.preference_switch_secure_settings_default_value";
    // Mutual exclusive dependencies for master switches
    private static final String EXTRA_SWITCH_SYSTEM_SETTINGS_MUTUAL_KEYS =
            "ru.baikalos.extras.extra.preference_switch_system_settings_mutual_keys";
    private static final String EXTRA_SWITCH_SECURE_SETTINGS_MUTUAL_KEYS =
            "ru.baikalos.extras.extra.preference_switch_secure_settings_mutual_keys";
    private static final String EXTRA_SWITCH_THERE_SHOULD_BE_ONE =
            "ru.baikalos.extras.extra.preference_switch_there_should_be_one";
