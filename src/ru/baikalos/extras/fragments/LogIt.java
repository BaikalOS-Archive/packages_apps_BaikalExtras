...
public class LogIt extends BaseSettingsFragment implements Preference.OnPreferenceChangeListener {
    ...
    private static final String KMSG_FILE = new File(Environment
        .getExternalStorageDirectory(), "baikalos_kmsg.txt").getAbsolutePath();
    private static final String DMESG_FILE = new File(Environment
        .getExternalStorageDirectory(), "baikalos_dmesg.txt").getAbsolutePath();
    ...
    private static final String HASTE_KMSG_KEY = new File(Environment
            .getExternalStorageDirectory(), "baikalos_haste_kmsg_key").getAbsolutePath();
    private static final String HASTE_DMESG_KEY = new File(Environment
            .getExternalStorageDirectory(), "baikalos_haste_dmesg_key").getAbsolutePath();

    private static final String BAIKALOS_HASTE = "http://haste.baikalos-rom.com/documents";
    ...
    private static final File dmesgHasteKey = new File(sdCardDirectory, "baikalos_haste_dmesg_key");
    private static final File kmsgFile = new File(sdCardDirectory, "baikalos_kmsg.txt");
