...
import ru.baikalos.extras.utils.FinishingAnimationDrawable;
import ru.baikalos.extras.utils.SuShell;
import ru.baikalos.extras.utils.SuTask;
...
public class SystemAnimations extends BaseSettingsFragment {
    ...
    private static final String BACKUP_PATH = new File(Environment
            .getExternalStorageDirectory(), "/BAIKALOS_backup").getAbsolutePath();
